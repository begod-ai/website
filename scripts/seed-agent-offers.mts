...
const seedSpecifications: SeedSpecification[] = [
  ...
  { minutesAgo: 62, eventType: "json_endpoint_fetch", variant: "D", userAgent: "OAI-SearchBot/seed", testRunId: "seed-openai-001", route: "/api/agent-offers/d" },
  ...
  { minutesAgo: 43, eventType: "json_endpoint_fetch", variant: "E", userAgent: "PerplexityBot/seed", testRunId: "seed-perplexity-001", route: "/api/agent-offers/e" },
  { minutesAgo: 41, eventType: "well_known_fetch", variant: "E", userAgent: "PerplexityBot/seed", testRunId: "seed-perplexity-001", route: "/.well-known/agent-offers.json" },
